...
namespace Class_Meth_Ass_2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // GOAL 3) Ask the user to input two numbers, one at a time. Let them know they need not enter anything for the second number
            ...
            if (string.IsNullOrEmpty(userNum2)) // Check if the user entered a second number or not, my way of doing this is to check if the value the user enters is null (empty) or not, if it is empty
            {
                ...
                // GOAL 4) Call the method in the class, passing in the one or two numbers entered
