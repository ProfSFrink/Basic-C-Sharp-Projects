...
## 04 - CONSOLE APPLICATION ASSIGNMENT [(CODE)]()
An assignment to demonstrate an understanding of iteration utilising both arrays and lists. Part 1 has us creating an array of strings, then requesting user input and then updating each element within the array with a concatenation of the value in that index plus the userr input, we then output each element in the updated array to the console.